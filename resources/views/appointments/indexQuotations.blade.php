...
@section('title', __('appointment.quotations_list') )

@section('content')
    <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-calendar-alt"></i> {{ __('appointment.quotations_list') }}</h1>
        ...
        <div class="card-body table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th>{{ __('quotation.total') }}</th>
                    <th>{{ __('quotation.is_cash') }}</th>
                ...
                @foreach($appointments as $appointment)
                    <tr>
                        ...
                        <td>{{ $appointment->quotations->first()->total }}</td>
                        <td>{{ $appointment->quotations->first()->is_cash}}</td>
