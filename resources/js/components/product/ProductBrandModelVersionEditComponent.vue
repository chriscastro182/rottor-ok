<template>
    <div id="model-brand-relation">
        ...
        <div class="form-group">
            ...
            <select id="version_id" class="form-control" name="version_id" v-model="version_selected">
                <option value="">.: Selecciona :.</option>
...
export default {
    name: "ProductBrandModelVersionEditComponent",
    props: ['brand_id', 'model_id', 'version_id'],
    data(){
        return {
            brand_title: 'Marca',
            model_title: 'Modelo',
    ...
    created() {
        this.brand_selected = this.brand_id;
        this.model_selected = this.model_id;
        this.version_selected = this.version_id;
        this.getBrands();
    },
    watch:{
