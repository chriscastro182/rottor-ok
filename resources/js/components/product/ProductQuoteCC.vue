<template>
    <div id="products-quotecc-table" class="table-responsive">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Cotización por Cilindrada</h6>
            ...
            <div class="card-body">
                ...
                <canvas id="products-quotecc-chart"></canvas>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getMost: function(){
            axios({
                url: '/api/customMarket/getMostCC',
                method: 'GET',
            }).then( (response) => {
                var prods = [];
        ...
        getLess: function(){
            axios({
                url: '/api/customMarket/getLessCC',
                method: 'GET',
            }).then( (response) => {
                var prods = [];
                response.data.data.forEach(function(element, id){
        ...
        setupChart: function(){
            ...
            var ctx = document.getElementById('products-quotecc-chart');
