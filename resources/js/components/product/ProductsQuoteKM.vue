<template>
    <div id="products-quotekm-table" class="table-responsive">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Cotización por KM</h6>
            ...
            <div class="card-body">
                ...
                <canvas id="products-quotekm-chart"></canvas>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getMost: function(){
            axios({
                url: '/api/customMarket/getMostKM',
                method: 'GET',
            }).then( (response) => {
                var prods = [];
        ...
        getLess: function(){
            axios({
                url: '/api/customMarket/getLessKM',
                method: 'GET',
            }).then( (response) => {
                var prods = [];
                console.info("Respuesta correcta de cotizaciones");
        ...
        setupChart: function(){
            ...
            var ctx = document.getElementById('products-quotekm-chart');
